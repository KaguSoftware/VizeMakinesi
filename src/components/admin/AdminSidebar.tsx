  ...
  return (
    <aside className="w-[240px] shrink-0 bg-navy flex flex-col min-h-screen">
      ...
      <div className="px-7 py-6 border-t border-white/10 flex flex-col gap-3">
        <p className="font-mono text-[10px] text-white/30 truncate">{email}</p>
        <form action="/admin/signout" method="post">
          <button
            type="submit"
            className="font-mono text-[11px] tracking-widest uppercase text-white/30 hover:text-coral transition-colors"
          >
            Çıkış
          </button>
        </form>
