        ...
        <div className="grid grid-cols-1 lg:grid-cols-[5fr_7fr] py-20 border-b border-border">
          ...
          <div className="pr-0 lg:pr-16">
            ...
            <div className="flex flex-col gap-3 mt-10 w-full max-w-xs">
              ...
              <a
                href={SITE.phoneHref}
                className="inline-flex items-center justify-center font-sans font-medium text-[13px] uppercase tracking-[0.1em] px-8 py-[22px] border border-navy text-navy hover:bg-navy hover:text-white transition-all duration-200"
              >
                Ofisi Arayın
              </a>
            </div>
