                        ...
                        <FadeIn as="div" delay={0.15}>
                            ...
                            <div className="flex flex-col gap-3 items-start w-full">
                                <a
                                    ...
                                    className="inline-flex items-center justify-center gap-3 font-sans font-medium text-[16px] uppercase tracking-[0.1em] px-10 py-7 bg-whatsapp border border-whatsapp text-white hover:bg-transparent hover:text-whatsapp active:scale-[0.98] transition-all duration-200 rounded-2xl whitespace-nowrap w-full focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-coral focus-visible:ring-offset-2"
                                >
