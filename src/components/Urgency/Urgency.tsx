  ...
  return (
    <section className="urgency-wrap bg-navy text-white py-[120px] relative overflow-hidden">
      <div className="container relative z-10">
        ...
        <p className="font-serif text-[22px] text-white/92 max-w-[620px] mt-9 leading-[1.45] border-l border-coral pl-6">
          {lede}
        </p>
        <div className="mt-10 flex gap-3 flex-wrap">
          <a
            className="inline-flex items-center font-sans font-medium text-[13px] uppercase tracking-[0.1em] px-8 py-[22px] bg-coral border border-coral text-white hover:bg-white hover:text-navy hover:border-white transition-all duration-200 rounded-2xl"
          ...
          <a
            className="inline-flex items-center font-sans font-medium text-[13px] uppercase tracking-[0.1em] px-8 py-[22px] border border-white/50 text-white hover:bg-white hover:text-navy transition-all duration-200 rounded-2xl"
