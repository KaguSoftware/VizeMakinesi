          ...
          <div className="pr-0 lg:pr-16">
            ...
            <FadeIn as="div" delay={0.3} className="flex flex-col gap-3 mt-10 w-full max-w-sm">
              <a
                ...
                className="inline-flex items-center justify-center gap-3 font-sans font-medium text-[13px] uppercase tracking-[0.1em] px-7 py-4 bg-whatsapp border border-whatsapp text-white hover:bg-transparent hover:text-whatsapp active:scale-[0.98] transition-all duration-200 rounded-2xl whitespace-nowrap focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-coral focus-visible:ring-offset-2"
              >
