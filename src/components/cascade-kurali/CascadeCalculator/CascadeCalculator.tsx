                  ...
                  <AnimatePresence mode="wait">
                    {selectedCountry ? (
                      ...
                      >
                        ...
                        >{selectedCountry.flag_emoji ?? "🌍"}</motion.span>
              ...
              <div className="flex items-center justify-between px-4 py-3 border-b border-navy/10">
                ...
                <div className="flex items-center gap-2">
                  <motion.div
                    ...
                    whileTap={{ scale: 0.95 }}
                    transition={{ type: "spring", stiffness: 400, damping: 22 }}
                    className="bg-[#fdfbe5] rounded-xl px-3 py-1.5"
                  >
                    <NativeSelect
                      coral
                      value={viewMonth}
            ...
            <AnimatePresence mode="wait">
              {canCalculate && result ? (
                <motion.div
                  ...
                  className={`border p-6 ${result.isBroken ? "border-red-300 bg-red-50" : result.isOutside ? "border-navy/20 bg-navy/5" : "border-coral/40 bg-coral/8"}`}
                >
                  <motion.div
                    initial={{ opacity: 0, x: -10 }}
                    animate={{ opacity: 1, x: 0 }}
                    transition={{ delay: 0.05, duration: 0.28, ease: [0.22, 1, 0.36, 1] }}
                    className="font-mono text-[10px] uppercase tracking-[0.18em] text-coral mb-3"
                  >
                    — Sonuç
                  </motion.div>
                  <motion.div
                    ...
                    className={`font-serif font-bold text-[22px] leading-tight mb-2 ${result.isBroken ? "text-red-700" : "text-navy"}`}
                  >
                    {result.label}
                  </motion.div>
                  <motion.p
                    ...
                    className="font-serif text-[13px] text-coral mb-5"
                ...
                <motion.div
                  ...
                  className="border border-navy/10 p-6 flex items-center justify-center min-h-32 bg-white"
                >
